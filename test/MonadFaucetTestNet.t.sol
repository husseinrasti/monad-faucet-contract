...
import {MonadFaucetTestNet} from "../src/MonadFaucetTestNet.sol";

contract MonadFaucetTestNetTest is Test {
    MonadFaucetTestNet public faucet;
    ...
    function setUp() public {
        ...
        vm.prank(owner);
        faucet = new MonadFaucetTestNet{value: 5 ether}();
